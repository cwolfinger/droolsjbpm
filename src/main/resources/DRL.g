...
@after { helper.popParaphrases(); }
	:	declare_key  type_declare_id (extends_key typeName)? (implements_key typeNameList)?
		decl_metadata*
		decl_field*
		decl_method*
		end_key
...
formalParameters
	:	LEFT_CURLY formalParameterDecls? RIGHT_CURLY
	;
...
annotation
	:	AT annotationName (LEFT_PAREN elementValuePairs? RIGHT_PAREN)?
	;
...
elementValuePair
	: (ID EQUALS)=> ID EQUALS elementValue
	| elementValue
	;
